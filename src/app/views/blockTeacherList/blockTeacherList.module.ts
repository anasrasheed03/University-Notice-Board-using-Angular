...
import { BlockTeacherListRoutingModule } from './blockTeacherList-routing.module';

@NgModule({
  imports: [
    CommonModule,
    FormsModule,
    BlockTeacherListRoutingModule,
    TabsModule,
    DataTableModule,
    SharedModule,
  ...
  providers: [],
  declarations: [ 
    BlockTeacherListComponent,
  ],
  bootstrap: [ BlockTeacherListComponent ]
})

export class BlockTeacherListModule {}
