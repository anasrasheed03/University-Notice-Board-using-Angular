...
import { BlockStaffListRoutingModule } from './blockStaffList-routing.module';
...
@NgModule({
  ...
  providers: [],
  declarations: [ 
    BlockStaffListComponent,
  ],
  bootstrap: [ BlockStaffListComponent ]
})

export class BlockStaffListModule {}
